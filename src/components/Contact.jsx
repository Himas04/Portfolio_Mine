      ...
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-5">
            ...
            {/* Quick Contact Cards */}
            <div className="bg-[#050C16]/25 hover:bg-[#050C16]/40 p-6 sm:p-7 rounded-3xl border border-[#38BDF8]/30 hover:border-[#38BDF8]/70 transition-all duration-300 space-y-5 shadow-2xl backdrop-blur-md">
              <h3 className="text-lg font-bold text-[#F0F9FF]">Direct Reach</h3>
              
              <div className="space-y-4">
                {/* Email Item */}
                <div className="flex items-center justify-between p-3.5 rounded-2xl bg-white/[0.04] border border-white/10 group hover:border-[#38BDF8]/60 hover:bg-white/[0.07] transition-all backdrop-blur-sm">
                  <div className="flex items-center gap-3">
                    <div className="p-2.5 rounded-xl bg-white/[0.06] text-[#38BDF8] border border-[#38BDF8]/30">
                  ...
                  <button
                    ...
                    className="p-2 rounded-lg text-[#94A3B8] hover:text-[#F0F9FF] bg-white/[0.05] hover:bg-white/[0.1] border border-white/10 transition-colors cursor-pointer"
                    title="Copy Email"
                  >
                ...
                <a
                  ...
                  className="flex items-center justify-between p-3.5 rounded-2xl bg-white/[0.04] border border-white/10 group hover:border-[#2DD4BF]/60 hover:bg-white/[0.07] transition-all backdrop-blur-sm"
                >
                  <div className="flex items-center gap-3">
                    <div className="p-2.5 rounded-xl bg-white/[0.06] text-[#2DD4BF] border border-[#2DD4BF]/30">
              ...
              <div className="pt-4 border-t border-white/10 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 p-3 rounded-xl bg-white/[0.04] hover:bg-white/[0.1] border border-white/10 hover:border-[#38BDF8] text-xs font-bold text-[#F0F9FF] transition-all backdrop-blur-sm"
                  >
          ...
          <div className="lg:col-span-7">
            <div className="bg-[#050C16]/25 hover:bg-[#050C16]/40 p-6 sm:p-8 rounded-3xl border border-[#38BDF8]/30 hover:border-[#38BDF8]/70 transition-all duration-300 space-y-6 shadow-2xl backdrop-blur-md">
              <div className="flex items-center justify-between border-b border-white/10 pb-4">
                ...
                <span className="text-[10px] font-mono text-[#2DD4BF] bg-white/[0.05] px-2.5 py-1 rounded-full border border-[#2DD4BF]/30 backdrop-blur-sm">
                  ● Direct Inbox API
                </span>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-white/[0.04] border border-white/10 focus:border-[#38BDF8] focus:bg-white/[0.07] focus:outline-none text-sm text-[#F0F9FF] placeholder-[#94A3B8]/60 transition-all backdrop-blur-sm"
                    />
                  </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-white/[0.04] border border-white/10 focus:border-[#38BDF8] focus:bg-white/[0.07] focus:outline-none text-sm text-[#F0F9FF] placeholder-[#94A3B8]/60 transition-all resize-none backdrop-blur-sm"
                  />
                </div>
              ...
              {submitStatus === 'success' && (
                <div className="p-4 rounded-2xl bg-white/[0.05] border border-[#2DD4BF]/80 text-[#2DD4BF] text-xs font-mono flex items-start gap-3 animate-in fade-in backdrop-blur-md">
              ...
              {submitStatus === 'activation_needed' && (
                <div className="p-4 rounded-2xl bg-white/[0.05] border border-[#38BDF8] text-[#7DD3FC] text-xs font-mono space-y-2 animate-in fade-in backdrop-blur-md">
